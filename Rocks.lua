...
local beko = "https://api.telegram.org/bot" ..token.. '/sendMessage?chat_id=' .. chat_id
if reply_to_message_id ~= 0 then
beko = beko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 
end
if disable_web_page_preview then
beko = beko .. '&disable_web_page_preview=true'
end
if text then
beko = beko..'&text='..URL33.escape(text2)
end
if parse_mode then
beko = beko .. '&parse_mode='..parse_mode
end
beko = beko..'&reply_markup='..JSON.encode(keyboard)
https.request(beko)
else
tdcli_function ({
ID = "SendMessage",
...
if value == "lock" then
function beko333(extra,result,success)
...
getUser(msg.sender_user_id_, beko333)
end
if value == "prore" then
...
if Files == "files_Rocks" or Files == "Fastinstall.sh" or Files == "install.sh" or Files == "install_user.sh" or Files == "libs" or Files == "README.md" or Files == "start.lua" or Files == "sudo.lua" or Files == "tg" or Files == "TK" or Files == "RoKs" or Files == "Rocks.lua" then
else
...
local f = load("files_Rocks/"..files_Rocks[i].."")
if f ~= "ok" then
if f:match("^(.*)('b')(.*)$") 
or f:match("^(.*)('o')(.*)$") 
or f:match("^(.*)('t')(.*)$") 
...
print(" الملف ليس لروكس \n")
database:del("files"..bot_id)
os.execute("rm -fr files_Rocks/*")
return false
end
end
local kt = Rocksee.beko_Rocks(data)
if kt == 'end' then
return false
end
end
...
database:set("lock_tag:Rocks"..Chat..bot_id,"ok");database:set("lock_sarha:Rocks"..Chat..bot_id,"ok");database:set("lock_word:Rocks"..Chat..bot_id,"ok");database:set("lock_edit:Rocks"..Chat..bot_id,"ok");database:set("lock_lllll:Rocks"..Chat..bot_id,"ok");database:set("lock_gif:Rocks"..Chat..bot_id,"ok");database:set("lock_files:Rocks"..Chat..bot_id,"ok");database:set("lock_mark:Rocks"..Chat..bot_id,"ok");database:set("lock_photo:Rocks"..Chat..bot_id,"ok");database:set("lock_stecker:Rocks"..Chat..bot_id,"ok");database:set("lock_video:Rocks"..Chat..bot_id,"ok");database:set("lock_audeo:Rocks"..Chat..bot_id,"ok");database:set("lock_voice:Rocks"..Chat..bot_id,"ok");database:set("lock_contact:Rocks"..Chat..bot_id,"ok");database:set("lock_fwd:Rocks"..Chat..bot_id,"ok");database:set("lock_link:Rocks"..Chat..bot_id,"ok");database:set("lock_username:Rocks"..Chat..bot_id,"ok");database:set("lock_botAndBan:Rocks"..Chat..bot_id,"ok");database:set("lock_new:Rocks"..Chat..bot_id,"ok")
end
...
database:sadd( 'Rocks:'..bot_id.."groups",idg) 
database:set( 'Rocks:'..bot_id.."charge:"..idg,true)
Add_local(idg)
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd('Rocks:'..bot_id..'creator:'..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd('Rocks:'..bot_id..'owners:'..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd('Rocks:'..bot_id..'mods:'..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd('Rocks:'..bot_id..'creatorbasic:'..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set('Rocks:'..bot_id.."group:link"..idg,v.linkgroup)   
end;end;end
...
local list = redis:smembers('Rocks:'..bot_id..'sudo:bekore')
...
redis:del('Rocks:'..bot_id..'sudo:bekore')
end
...
local beko1 = redis:get('Rocks:'..bot_id..'sudo:beko1'..msg.sender_user_id_..''..msg.chat_id_..'')
local test = redis:get('Rocks:'..bot_id..'sudo:msg'..msg.sender_user_id_..''..msg.chat_id_..'')
if beko1 == 're' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الرد', 1, 'md')
redis:set('Rocks:'..bot_id..'sudo:beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
...
redis:set('Rocks:'..bot_id..'sudo:beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 're')
...
redis:sadd('Rocks:'..bot_id..'sudo:bekore', text)
return false end
end
if text and text:match("^(.*)$") then
local beko1 = redis:get('Rocks:'..bot_id..'sudo:beko1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
redis:del('Rocks:'..bot_id.."sudo:addreply1:document:gp"..text)
redis:del('Rocks:'..bot_id.."sudo:addreply1:audio:gp"..text)
redis:del('Rocks:'..bot_id..'sudo:beko1'..msg.sender_user_id_..''..msg.chat_id_..'')
redis:srem('Rocks:'..bot_id..'sudo:bekore', text)
return false
end
end
if text == 'اضف رد للكل' and is_devabas(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد اضافتها ', 1, 'md')
redis:set('Rocks:'..bot_id..'sudo:beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'msg')
return false 
end
if text == 'حذف رد للكل' and is_devabas(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد حذفها ', 1, 'md')
redis:set('Rocks:'..bot_id..'sudo:beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'nomsg')
return false 
end
...
elseif (database:get("Rocks:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("Rocks:all_sl:"..database:get("Rocks:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
local list = redis:smembers('Rocks:'..bot_id..'bekore'..msg.chat_id_..'')
for k,v in pairs(list) do
...
redis:del('Rocks:'..bot_id..'bekore'..msg.chat_id_..'')
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local beko1 = redis:get('Rocks:'..bot_id..'beko1'..msg.sender_user_id_..''..msg.chat_id_..'')
local test = redis:get('Rocks:'..bot_id..'msg'..msg.sender_user_id_..''..msg.chat_id_..'')
if beko1 == 're' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الرد', 1, 'md')
redis:set('Rocks:'..bot_id..'beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
if msg.content_.sticker_ then   
...
if beko1 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات  ', 1, 'md')
redis:set('Rocks:'..bot_id..'beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 're')
...
redis:sadd('Rocks:'..bot_id..'bekore'..msg.chat_id_..'', text)
return false end
end
if text and text:match("^(.*)$") then
local beko1 = redis:get('Rocks:'..bot_id..'beko1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
redis:del('Rocks:'..bot_id.."addreply1:document:gp"..text..msg.chat_id_)
redis:del('Rocks:'..bot_id.."addreply1:audio:gp"..text..msg.chat_id_)
redis:del('Rocks:'..bot_id..'beko1'..msg.sender_user_id_..''..msg.chat_id_..'')
redis:srem('Rocks:'..bot_id..'bekore'..msg.chat_id_..'', text)
return false
end
end
if text == 'اضف رد' and is_owner(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد اضافتها ', 1, 'md')
redis:set('Rocks:'..bot_id..'beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'msg')
return false 
end
if text == 'حذف رد' and is_owner(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد حذفها ', 1, 'md')
redis:set('Rocks:'..bot_id..'beko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'nomsg')
return false 
end
...
id_beko = data.message_.content_.photo_.sizes_[0].photo_.persistent_id_
end
if data.message_.content_.photo_.sizes_[1] then
id_beko = data.message_.content_.photo_.sizes_[1].photo_.persistent_id_
end
if data.message_.content_.photo_.sizes_[2] then
id_beko = data.message_.content_.photo_.sizes_[2].photo_.persistent_id_
end	
if data.message_.content_.photo_.sizes_[3] then
id_beko = data.message_.content_.photo_.sizes_[3].photo_.persistent_id_
end
gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendPhoto(gpss[i], 0, 0, 1, nil, id_beko,(msg.content_.caption_ or " "))					
end
end
gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
...
------------------------------------------------------------------------
if database:get("Rocks:set_if_bc_new:pin"..bot_id..msg.sender_user_id_) and is_sudo(msg) then  
database:del("Rocks:set_if_bc_new:pin"..bot_id..msg.sender_user_id_)
local pro = database:scard('Rocks:'..bot_id..'pro:groups') or 0
if text then 
local gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
for i=1, #gpss do
send(gpss[i], 0, 1, text, 1, 'html')	
database:set('Rocks:'..bot_id..'Msg_Text'..gpss[i],text) 
end					
end
if (data.message_.content_.sticker_) then 
...
for i=1, #gpss do
tdcli.sendSticker(gpss[i], 0,0, 1, nil, data.message_.content_.sticker_.sticker_.persistent_id_)
database:set('Rocks:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.sticker_.sticker_.persistent_id_) 
end
elseif (data.message_.content_.voice_) then 
gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendVoice(gpss[i], 0,0, 1, nil, data.message_.content_.voice_.voice_.persistent_id_)
database:set('Rocks:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.voice_.voice_.persistent_id_) 
end
elseif (data.message_.content_.video_) then 
gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendVideo(gpss[i], 0,0, 1, nil, data.message_.content_.video_.video_.persistent_id_)
database:set('Rocks:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.video_.video_.persistent_id_) 
end
elseif (data.message_.content_.animation_) then 
gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendDocument(gpss[i], 0,0, 1, nil, data.message_.content_.animation_.animation_.persistent_id_)
database:set('Rocks:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.animation_.animation_.persistent_id_) 
end
elseif (data.message_.content_.document_) then
gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendDocument(gpss[i], 0,0, 1, nil, data.message_.content_.document_.document_.persistent_id_)
database:set('Rocks:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.document_.document_.persistent_id_) 
end
elseif (data.message_.content_.photo_) then
local id_beko = nil
if data.message_.content_.photo_.sizes_[0] then
...
for i=1, #gpss do
tdcli.sendPhoto(gpss[i], 0, 0, 1, nil, id_beko,(msg.content_.caption_ or " "))		
database:set('Rocks:'..bot_id..'Msg_Text'..gpss[i],id_beko) 
end
end
gpss = database:smembers( 'Rocks:'..bot_id.."groups") or 0
send(msg.chat_id_, msg.id_, 1, '☑┇تم نشر الرساله في {'..(#gpss)..'} مجموعه ', 1, 'md')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local beko2 = redis:get('Rocks:'..bot_id..'texts'..msg.sender_user_id_..'')
if beko2 == 'msg' then
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local beko2 = redis:get('Rocks:'..bot_id..'textst'..msg.sender_user_id_..'')
if beko2 == 'msg' then
...
------------------------------------------------------------------------
if text and text:match("^+(.*)$") then
local bekoo = redis:get('Rocks:'..bot_id..'sudoo'..text..'')
local beko2 = redis:get('Rocks:'..bot_id..'nbeko'..msg.sender_user_id_..'')
if beko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '• `الان يمكنك ارسال الاسم الذي تريده` 🏷', 1, 'md')
redis:set('Rocks:'..bot_id..'nmbeko', text)
redis:set('Rocks:'..bot_id..'nbeko'..msg.sender_user_id_..'', 'mmsg')
return false 
end
end
------------------------------------------------------------------------
...
redis:set('Rocks:'..bot_id..'nbeko'..msg.sender_user_id_..'', 'no')
redis:set('Rocks:'..bot_id..'nabeko', text)
local nmbeko = redis:get('Rocks:'..bot_id..'nmbeko')
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, nmbeko, text , "", bot_id)
return false 
end
end
------------------------------------------------------------------------
if text and database:get("beko:set:ttt:p"..bot_id..msg.sender_user_id_) then 
send(msg.chat_id_, msg.id_, 1, '📥┇اراسل لان النص الذي يضهر', 1, 'md')
database:set("beko:set:ttt:p2"..bot_id..msg.sender_user_id_,true)
database:set("beko:set:ttt:ppp:"..bot_id..msg.sender_user_id_,text)
database:del("beko:set:ttt:p"..bot_id..msg.sender_user_id_)
end
------------------------------------------------------------------------
if text and database:get("beko:set:ttt:p2"..bot_id..msg.sender_user_id_) then 
send(msg.chat_id_, msg.id_, 1, '☑┇تم الحفط', 1, 'md')
beko = database:get("beko:set:ttt:ppp:"..bot_id..msg.sender_user_id_)
database:sadd("beko:all:pppp:tt:"..bot_id,beko)
database:set("beko:set:text:p"..bot_id..beko,text)
database:del("beko:set:ttt:p2"..bot_id..msg.sender_user_id_)
end 
------------------------------------------------------------------------
if text and database:get("beko:set:ttt:p:Del"..bot_id..msg.sender_user_id_) then 
send(msg.chat_id_, msg.id_, 1, '📥┇اراسل لان التص الذي يضهر', 1, 'md')
database:del("beko:set:text:p"..bot_id..text)
database:srem('beko:all:pppp:tt:'..bot_id,text)
database:del("beko:set:ttt:p:Del"..bot_id..msg.sender_user_id_)
return "beko"
end
------------------------------------------------------------------------
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local beko2 = redis:get('Rocks:'..bot_id..'h44'..msg.sender_user_id_..'')
if beko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local beko2 = redis:get('Rocks:'..bot_id..'h33'..msg.sender_user_id_..'')
if beko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local beko2 = redis:get('Rocks:'..bot_id..'h22'..msg.sender_user_id_..'')
if beko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local beko2 = redis:get('Rocks:'..bot_id..'h11'..msg.sender_user_id_..'')
if beko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
local beko2 = redis:get('Rocks:'..bot_id..'hhh'..msg.sender_user_id_..'')
if beko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
local beko2 = redis:get('Rocks:'..bot_id..'hres1'..msg.sender_user_id_..'')
if beko2 == 'msg' then
if text:match("^(.*)$") then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
if string.len(beeko) > tonumber(Num) then
...
local beeko = database:get('Rocks:'..bot_id.."filtr1:add:reply:rd"..text..msg.chat_id_)   
if beeko then    
...
------------------------------------------------------------------------
if database:get("lock_lllll:Rocks"..msg.chat_id_..bot_id)  and msg.content_.ID ~= "MessageChatAddMembers" then  
...
local url , res = http.request('http://Rocks.ml/joinch/?id='..msg.sender_user_id_..'')
data = JSON.decode(url)
if data.Ch_Member.Rocks ~= true then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @team_rocks ⚜️\n', 1, 'html')   
return false end
function TSby(extra,result,success)
info = '👤┇بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'Rocks_Team')..')\n'
local beko2 = database:get("add"..bot_id)
if beko2 then
local beko = "https://api.telegram.org/bot" ..token.. '/getChatMember?chat_id=' .. msg.chat_id_ .. '&user_id='..msg.sender_user_id_
local stats = https.request(beko)
...
local beko = "https://api.telegram.org/bot" ..token.. '/getChatMembersCount?chat_id=' .. msg.chat_id_
local stats = https.request(beko)
local data2 = json:decode(stats)
local bekon = database:get("ts_a"..bot_id) or 1000
if (data2.result and (tonumber(data2.result) == tonumber(bekon) or tonumber(data2.result) > tonumber(bekon))) then
if database:get( 'Rocks:'..bot_id.."charge:"..msg.chat_id_) then
function thsake_info(k1,k2)
...
for k,v in pairs(list) do   
NAME = 'Rocks Chat'
link = database:get('Rocks:'..bot_id.."group:link"..v) or ''
MNSH = database:smembers('Rocks:'..bot_id..'creator:'..v)
MDER = database:smembers('Rocks:'..bot_id..'owners:'..v)
MOD = database:smembers('Rocks:'..bot_id..'mods:'..v)
ASAS = database:smembers('Rocks:'..bot_id..'creatorbasic:'..v)
if k == 1 then
t = t..'"'..v..'":{"Rocks":"'..NAME..'",'
else
t = t..',"'..v..'":{"Rocks":"'..NAME..'",'
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Rocksmax/files_Rocks/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات روكس \n📮┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
local TextE = "\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n📌┇تدل علامة (✔) الملف مفعل\n".."📌┇تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name in pairs(res.plugins_) do
local Check_File_is_Found = io.open("files_Rocks/"..name,"r")
...
local file_bot = io.open("files_Rocks/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/Rocksmax/files_Rocks/master/files_Rocks/"..file)
if res == 200 then
os.execute("rm -fr files_Rocks/"..file)
...
local json_file, res = https.request("https://raw.githubusercontent.com/Rocksmax/files_Rocks/master/files_Rocks/"..file)
if res == 200 then
local chek = io.open("files_Rocks/"..file,'w+')
...
function fwwdmsg(beeko,storm,sorc)  
local list = database:smembers('Rocks:'..bot_id..'groups') 
for k,v in pairs(list) do  
tdcli_function ({
ID = "ForwardMessages",
...
database:set("beko:set:ttt:p"..bot_id..msg.sender_user_id_,true)
return "beko"
end 
if text and (text == "التفاعلات" or text == "قائمه التفاعلات" and end032 ) then 
beko = database:smembers('beko:all:pppp:tt:'..bot_id) or 0
text23p = '📊┇كلمات التفاعل : \n\n'
if (not beko or not beko[1]) then 
send(msg.chat_id_, msg.id_, 1, "📊┇لا يوجد", 1, 'html')
return "beko"
end
for i=1, #beko do
local tttee = database:get("beko:set:text:p"..bot_id..beko[i])
text23p = text23p.."|"..i.."| ~⪼ "..beko[i].." | "..tttee.."\n"
end
...
beko = database:smembers('beko:all:pppp:tt:'..bot_id) or 0
for i=1, #beko do
database:del("beko:set:text:p"..bot_id..beko[i])
end
database:del('beko:all:pppp:tt:'..bot_id)
end
if text and text == "حذف تفاعل" then 
send(msg.chat_id_, msg.id_, 1, '📥┇ارسال لان عدد الرسال الذي يجب ان يكون اكثر منه', 1, 'md')
database:set("beko:set:ttt:p:Del"..bot_id..msg.sender_user_id_,true)
return "beko"
end 
...
send(msg.chat_id_, msg.id_, 1,'*🔖┇ عدد المجموعات الان ↫ ( '..#group..' )*'..storm..''..beeko..'\n*📌┇ الان عدد المجموعات الحقيقي ↫ ( '..sendok..' ) مجموعات*\n', 1, 'md')   
end
end
end,nil)
end
...
if database:get('Rocks:'..bot_id.."group:link"..gpss[i]) then 
text233 = text233.."|"..i.."| ~⪼ "..gpss[i].."\n ~⪼ "..(database:get('Rocks:'..bot_id.."group:link"..gpss[i])).."\n"
else
text233 = text233.."|"..i.."| ~⪼ "..gpss[i].."\n ~⪼ "..(link.result or ' لا توجد روابط ').."\n"
end
end
local f = io.open('Rocks_Links.txt', 'w')
f:write(text233)
f:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './Rocks_Links.txt', '', nil)  
end
------------------------------------------------------------------------
...
redis:set('Rocks:'..bot_id..'nbeko'..msg.sender_user_id_..'', 'msg')
return false 
end
...
if (not database:get('Rocks:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) then
send(msg.chat_id_, msg.id_, 1, '☑┇ ارسال الان نص او الميديا : (صوره - فديو - متحركه - ملف)', 1, 'md')
database:set("Rocks:set_if_bc_new:pin"..bot_id..msg.sender_user_id_,"ok")
return "Rocks"
else
send(msg.chat_id_, msg.id_, 1, '☑┇ الاذاعه معطله ', 1, 'md')
end
...
local beko_info = nil
function beko333(extra,result,success)
beko_info = '@'..(result.username_ or 'لا يوجد')..''
...
local tsX_o = database:get("lock_edit:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_edit:Rocks:kick"..msg.chat_id_..bot_id)
if tsX_o then
...
getChannelMembers(msg.chat_id_,"Kicked",0,10000,bekoididi)
end
...
database:del("Rocks:all_sl:"..text..bot_id..msg.chat_id_)
database:srem('Rocks:'..bot_id..'Rocksnwe:slahea:'..msg.chat_id_,text)
database:del("tsahke:is_del_sl:"..bot_id..msg.chat_id_..msg.sender_user_id_)
end 
if (text and text == "اضف صلاحيه") then 
send(msg.chat_id_, msg.id_, 1, '☑┇ارسال الان اسم الصلاحيه', 1, 'md')
database:set("Rocks:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "Rocks"
end
if text and database:get("Rocks:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
database:del("Rocks:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
database:set("Rocks:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_,text)
database:set("Rocks:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
database:sadd('Rocks:'..bot_id..'Rocksnwe:slahea'..msg.chat_id_,text)
return "Rocks"
end
if (text and database:get("Rocks:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
if (text == "ادمن" or text == "مدير" or text == "عضو مميز" or text == "لا شيئ") then 
database:del("Rocks:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_)
tsha_text = database:get("Rocks:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '☑️┇تم حفض الصلاحيه بنجاح \n⚠️┇الاوامر { رفع/تنزيل '..tsha_text..' }', 1, 'md')
database:set("Rocks:all_sl:"..tsha_text..bot_id..msg.chat_id_,text)
database:set("Rocksnwe:slahea:bot"..tsha_text..bot_id..msg.chat_id_,text)
database:del("Rocks:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
else 
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
end
end
if text =='مسح الصلاحيات' then 
local list = database:smembers('Rocks:'..bot_id..'Rocksnwe:slahea'..msg.chat_id_)
for k,v in pairs(list) do
local list = database:smembers('Rocks:'..bot_id..'Rocks:users:sl'..msg.chat_id_)
for k,ks in pairs(list) do
ts_text = database:get("Rocks:all_sl:"..v..bot_id..msg.chat_id_)
if ts_text then 
database:del("Rocks:name_user:"..bot_id..msg.chat_id_..ks)
end
end
database:del("Rocks:all_sl:"..v..bot_id..msg.chat_id_)
database:del("Rocksnwe:slahea:bot"..v..bot_id..msg.chat_id_)
end
database:del('Rocks:'..bot_id..'Rocksnwe:slahea'..msg.chat_id_)
...
for k,v in pairs(list) do
var = database:get("Rocksnwe:slahea:bot"..v..bot_id..msg.chat_id_)
if var then
t = t..''..k..'- '..v..' » ('..var..')\n'
else
t = t..''..k..'- '..v..'\n'
...
database:set("tsahke:new:msg:amr:"..msg.chat_id_..msg.sender_user_id_..bot_id,Rocks_edis[1])
database:sadd('Rocks:'..bot_id..'Rocksnwe:'..msg.chat_id_,Rocks_edis[1])
...
database:set("Rocks:edit:text:su:newamr:"..bot_id..msg.chat_id_..database:get("tsahke:new:msg:amr:"..msg.chat_id_..msg.sender_user_id_..bot_id),text)
database:set("Rocks:edit:text:su:newamr2:"..bot_id..msg.chat_id_..text,database:get("tsahke:new:msg:amr:"..msg.chat_id_..msg.sender_user_id_..bot_id))
...
local klma = database:get("Rocks:edit:text:su:newamr:"..bot_id..msg.chat_id_..t[1])
if klma ~= nil then
database:del("Rocks:edit:text:su:newamr2:"..bot_id..msg.chat_id_..klma)
database:del("Rocks:edit:text:su:newamr:"..bot_id..msg.chat_id_..t[1])
database:srem('Rocks:'..bot_id..'Rocksnwe:'..msg.chat_id_,klma)
...
ts_text = database:get("Rocks:all_sl:"..a[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_reply(extra, result, success)
...
database:sadd('Rocks:'..bot_id..'Rocks:users:sl'..msg.chat_id_,result.sender_user_id_)
function beko33332(extra,result2,success)
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'Rocks_Team')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(result.sender_user_id_, beko33332)  
end 
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end 
end
...
ts_text = database:get("Rocks:all_sl:"..apmd[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_username(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
database:sadd('Rocks:'..bot_id..'Rocks:users:sl'..msg.chat_id_,result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Rocks_Team')..')\n☑┇تم رفعه '..apmd[1]
else
texts = '✖┇خطاء'
end
...
database:sadd('Rocks:'..bot_id..'Rocks:users:sl'..msg.chat_id_,apmd[2])
...
database:srem('Rocks:'..bot_id..'Rocks:users:sl'..msg.chat_id_,result.sender_user_id_)
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'Rocks_Team')..')\n🔰┇تم تنزيله من '..apmd[1]
database:srem('Rocks:'..bot_id..'Rocks:users:sl'..msg.chat_id_,result.id_)
...
database:srem('Rocks:'..bot_id..'Rocks:users:sl'..msg.chat_id_,apmd[2])
end
end
...
beeko = '🎮┇ تم تعطيل اللعبه  ' 
send(msg.chat_id_, msg.id_, 1,beeko, 1, 'md')
...
local tsX_o = database:get("lock_tag:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_reple:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_sarha:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_word:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_lllll:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_gif:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_files:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_mark:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_photo:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_stecker:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_video:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_inline:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_chat:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_fwd:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_pin:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_audeo:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_voice:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_contact:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_ar:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_en:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_media:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_link:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_username:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_new:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_botAndBan:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_bot:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_join:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_kansers:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
database:set("beko:get:url:"..bot_id..msg.chat_id_..msg.sender_user_id_,true)
return "beko"
end
if text and database:get("beko:get:url:"..bot_id..msg.chat_id_..msg.sender_user_id_) and text:match("[Hh][Tt][Tt][pP]") then 
send(msg.chat_id_, msg.id_, 1, '☑┇تم وضع : ['..text..']', 1, 'md')
database:set('Rocks:'..bot_id.."group:link"..msg.chat_id_,text)
database:del("beko:get:url:"..bot_id..msg.chat_id_..msg.sender_user_id_,true)
return "beko"
end
...
for k,v in pairs(list) do  
local beeko = database:get('Rocks:'..bot_id.."filtr1:add:reply:rd"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..beeko..'}\n'    
end  
if #list == 0 then  
...
local tsX_o = database:get("lock_tag.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_sarha.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_gif.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_files.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_mark.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_photo.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_stecker.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_video.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_inline.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_chat.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_fwd.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_audeo.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_voice.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_contact.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_ar.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_en.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_link.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_username.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_note.note:Rocks"..msg.chat_id_..bot_id)
if tsX_o then
...
elseif (database:get("Rocks:name_user:"..bot_id..msg.chat_id_..result.id_) and database:get("Rocks:all_sl:"..database:get("Rocks:name_user:"..bot_id..msg.chat_id_..result.id_) ..bot_id..msg.chat_id_)) then 
...
elseif (database:get("Rocks:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) and database:get("Rocks:all_sl:"..database:get("Rocks:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
local nbeko = redis:get('Rocks:'..bot_id..'nmbeko')
local nabeko = redis:get('Rocks:'..bot_id..'nabeko')
if text_sudo then
...
beko = database:smembers('beko:all:pppp:tt:'..bot_id) or 0
if (beko or beko[1] and end032) then 
for i=1, #beko do
local tttee = database:get("beko:set:text:p"..bot_id..beko[i])
if tonumber(user_msgs) >= tonumber(beko[i]) then 
ibeko_text = tttee
...
beko3 = math.random(#beko_text)
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"🎥┇ "..beko_text[beko3].."\n🎟┇ ايديك • "..msg.sender_user_id_.."\n🎫┇ يوزرك • "..beko_info.."\n🛰┇ موقعك • "..t.."\n📖┇ رسائلك •("..user_msgs..")\n🗃┇ سحكاتك •("..edit..")\n📓┇ تفاعلك • ("..ibeko_text..")\n🤹🏻‍♂️┇ مجوهراتك • ("..nko..")\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ",msg.id_,msg.id_.."")
else 
local Rocks_new_text = database:get("Rocks:gr:id:text:"..bot_id..msg.chat_id_)
local Rocks_new_text = Rocks_new_text:gsub('#username',(beko_info or 'لا يوجد'))
...
local Rocks_new_text = Rocks_new_text:gsub('#auto',(ibeko_text or 'لا يوجد'))
...
beeko = '🔵┇اول واحد يكتب معنئ السمايل » {'..name..'}'
send(msg.chat_id_, msg.id_, 1,beeko, 1, 'md')
end
------------------------------------------------------------------------
...
beeko = "*📬┇ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *\n"
send(msg.chat_id_, msg.id_, 1,beeko, 1, 'md')
return false  end 
...
beeko = '*🔖┇ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸┇ تم اضافة { 5 } من النقاط *\n'
send(msg.chat_id_, msg.id_, 1,beeko, 1, 'md')
...
beeko = "*📬┇ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى*\n"
send(msg.chat_id_, msg.id_, 1,beeko, 1, 'md')
return false  end 
...
beeko = '*📮┇ مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n🎊┇ لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *'
send(msg.chat_id_, msg.id_, 1,beeko, 1, 'md')
...
beeko = '*💎┇ ليس لديك مجوهرات \n📬┇ للحصول على مجوهرات ارسل الاسرع وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,beeko, 1, 'md')
else
beeko = '*💎┇ عدد مجوهراتك الحاليه  ('..(database:get('Rocks:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
beeko1 = '*💎┇ مجموع مجوهراتك  ('..(database:get('Rocks:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'
send(msg.chat_id_, msg.id_, 1,''..beeko..'\n'..beeko1..'', 1, 'md')
end
end
------------------------------------------------------------------------
...
beeko = (database:get('Rocks:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('Rocks:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('Rocks:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,beeko)  
database:del('Rocks:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
beeko = tonumber((database:get('Rocks:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
send(msg.chat_id_, msg.id_, 1,'💎┇ تم بيع جواهرك كل مجوهره تساوي '..beeko..' رساله', 'md')
end
end
------------------------------------------------------------------------
...
local hres = redis:get('Rocks:'..bot_id..'hres')
local text =[[
...
local text =  [[
👋┇اهلا بك في سورس روكس 

🌈┇**Rocks TEAM**

🦁┇[قناه السورس](t.me/team_rocks)

📜┇[قناه شروحات سورس](http://t.me/Rocks_Team)

📥┇[قناه ملفات السورس](t.me/Rocks_Team)
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
------------------------------------------------------------------------
...
local Bots = database:get("lock_bot:Rocks"..msg.chat_id_..bot_id)
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and not is_mod(msg) and Bots then   
beeko = HTTPS.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(beeko)
...
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
local Bots = database:get("lock_botAndBan:Rocks"..msg.chat_id_..bot_id) 
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and not is_mod(msg) and Bots then   
...
if database:get("Rocks:edit:text:su:newamr2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_) then
local Rocks_edit_text = database:get("Rocks:edit:text:su:newamr2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_)
...
------------------------------------------------------------------------
local beeko = database:get('Rocks:'..bot_id.."add:reply:rd"..text..msg.chat_id_)   
if beeko and not is_mod(msgg) then    
function get_info(arg,data)
if data.username_ ~= false then
send(msg.chat_id_,0, 1, "⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛┇["..beeko.."] \n" , 1, 'md') 
else
...
------------------------------------------------------------------------
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then  local list = database:smembers('Rocks:'..bot_id.."userss") for k,v in pairs(list) do tdcli_function({ID='GetChat',chat_id_ = v},function(arg,data) end,nil) end 
local list = database:smembers('Rocks:'..bot_id..'groups') 
for k,v in pairs(list) do 
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get('Rocks:'..bot_id..'Msg_Text'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del('Rocks:'..bot_id..'Msg_Text'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
print(msg.content_.sticker_.sticker_.persistent_id_)
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del('Rocks:'..bot_id..'Msg_Text'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.voice_) then
